...
const SearchComicItem = ({ item, chapter }) => {
      ...
      <div className="product__item">
        ...
        >
          ...
          {currentPath === "/favorite-comic" && (
            <div className="ep1" onClick={handleDeleteFavorite}>
              X
            </div>
          )}
          {currentPath === "/history-reading" && (
            <div className="ep1" onClick={handleDeleteHistory}>
              X
            </div>
          )}
        ...
        <div className="product__item__text">
          ...
          {currentPath === "/history-reading" && (
            <span onClick={() => insertHistoryReading(chapter.id)}>
              <Link to={`/chapter/${chapter.id}`}>
                Chapter {chapter.ordinalNumber}
              </Link>
            </span>
          )}
        </div>
